...
```
.codex/agents/          — 28 specialized subagents
.codex/skills/          — 125 workflow skills and domain knowledge
.codex/commands/        — 60 slash commands
hooks/           — Trigger-based automations
.codex/rules/           — Always-follow guidelines (common + per-language)
